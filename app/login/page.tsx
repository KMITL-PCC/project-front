    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-linear-to-t from-white from-67% to-kmitl font-sans">
      <div className="w-full max-w-[380px] space-y-8 flex flex-col items-center">
        <div className="flex flex-col items-center p-8 md:p-0">    
            ...
            {/* STEP 1: ค้นหาห้อง (ต้องทำเป็นอันดับแรก) */}
            <div className="space-y-2">
                ...
                className={`w-full h-14 justify-between border-2 rounded-xl transition-all shadow-sm font-semibold text-base
                    ${selectedRoom ? "border-green-500 bg-green-50/30 text-green-700" : "border-slate-200 text-slate-600 hover:border-orange-300"}`}
                >
                <div className="flex items-center gap-2">
                    <MapPin size={18} className={selectedRoom ? "text-green-500" : "text-slate-400"} />
            ...
            {/* STEP 2: แสดงผลเมื่อเลือกห้องแล้วเท่านั้น */}
            {selectedRoom && (
                ...
                <div className="pt-2 border-t border-slate-100 mt-4">
                    ...
                    <div className="space-y-4 animate-in fade-in slide-in-from-top-2 duration-300 pt-4">
                        ...
                        className="h-12 border-slate-200 rounded-xl focus-visible:ring-orange-500 shadow-sm"
                        />
                        <Button className="w-full h-12 bg-[#f15a22] hover:bg-[#d44d1d] text-white font-bold rounded-xl shadow-lg shadow-orange-200 transition-all active:scale-[0.98]">
                        Sign In
                        </Button>
                    </div>
                    ) : (
                    <div className="animate-in fade-in slide-in-from-top-2 duration-300 pt-4 text-center">
                        <Button variant="outline" className="w-full h-12 border-2 border-slate-200 text-slate-600 font-bold rounded-xl hover:bg-slate-50 transition-all">
                        Continue as Guest
                        </Button>
                    </div>
                    )}
